...
namespace InvoicesOnCloudBackEnd.Panels
{
    /// <summary>
    /// Examples of mathematical methods
    /// </summary>
    static public class MathematicalMethods
    {
        /// <summary>
      ...
      static  public  double CalculateAverage(double a, double b, double c)
        {
            return (a + b + c) / 3;
        }
      ...
      static  public  int FindMaximum(int a, int b)
        {
            return (a > b) ? a : b;
        }
      ...
      static  public  double CalculatePower(double baseNumber, int exponent)
        {
   ...
   static     public  bool IsSumDivisibleBy(int a, int b, int divisor)
        {
            int sum = a + b;
